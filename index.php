...
<body class="Home">
	...
	<section id="menu-abas">
		...
		<p id="megashow">
			A partir de 2/10, ao chegar no estacionamento do Mooca Plaza Shopping, o visitante já se sentirá transportado para um lugar fantástico ao se deparar com o imponente castelo de mais de 1.500 mts² montado para receber A Bela e A Fera Experience. Toda a experiência começa ao entrar em um encantado foyer perfeito para incríveis registros fotográficos.
			<br><br> 
		...
		<video id='videolol' src="<? echo $images ?>bela.mp4" preload="auto" type="video/mp4" controls poster="<? echo $images ?>bela_Moment.jpg"></video>
